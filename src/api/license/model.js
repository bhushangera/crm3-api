...
licenseSchema.methods = {
  view(full) {
    const view = {
      ...
      planCharges: this.planCharges,
      cloudPlanCharges: this.cloudPlanCharges,
      backupCharges: this.backupCharges,
      demoMode: this.demoMode,
      demoExpiry: this.demoExpiry,
...
const model = mongoose.model("License", licenseSchema);
